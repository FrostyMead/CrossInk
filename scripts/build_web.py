...
PAGES = {
    "home":     ("HomePageHtml",     "FrostInk",                   "home",     ""),
    "files":    ("FilesPageHtml",    "Files - FrostInk",           "files",    '  <script src="/js/jszip.min.js"></script>'),
    "settings": ("SettingsPageHtml", "Settings - FrostInk",        "settings", ""),
    "fonts":    ("FontsPageHtml",    "Fonts - FrostInk",           "fonts",    ""),
}
